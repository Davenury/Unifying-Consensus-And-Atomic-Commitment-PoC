    ...
    override fun applyTransaction(trx: TransactionContext): CompletableFuture<Message> {
        ...
        if (operationError != null) {
            return CompletableFuture.completedFuture(
                Message.valueOf(operationError)
            )
        }
        ...
        val f: CompletableFuture<Message> = CompletableFuture.completedFuture(Message.valueOf(serializeState()))
