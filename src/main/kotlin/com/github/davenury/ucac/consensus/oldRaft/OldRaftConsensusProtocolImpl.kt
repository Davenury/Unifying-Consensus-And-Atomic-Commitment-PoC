...
/** @author Kamil Jarosz */
class OldRaftConsensusProtocolImpl(
    ...
    private val protocolClient: OldRaftProtocolClient,
...
) : OldRaftConsensusProtocol, SignalSubject {
    ...
    constructor(
        ...
        protocolClient: OldRaftProtocolClient,
    ...
    private suspend fun sendLeaderRequest(): Unit = span("Raft.sendLeaderRequest") {
        ...
        signalPublisher.signal(
            ...
            this@OldRaftConsensusProtocolImpl,
    ...
    override suspend fun handleRequestVote(
        ...
        mutex.withLock {
            if (iteration < currentTerm || (iteration == currentTerm && votedFor != null)) {
                ...
                return ConsensusElectedYou(this@OldRaftConsensusProtocolImpl.peerId, currentTerm, false)
            }
        ...
        return ConsensusElectedYou(this@OldRaftConsensusProtocolImpl.peerId, currentTerm, true)
    }
        ...
        return mutex.withLock {
            ...
            heartbeat.logEntries.forEach {
                ...
                signalPublisher.signal(
                    ...
                    subject = this@OldRaftConsensusProtocolImpl,
