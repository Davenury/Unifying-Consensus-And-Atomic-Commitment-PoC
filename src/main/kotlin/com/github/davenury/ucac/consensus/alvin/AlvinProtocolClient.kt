...
class AlvinProtocolClientImpl: AlvinProtocolClient, ConsensusProtocolClient() {
    ...
    override suspend fun sendProposal(
        ...
        return sendRequest<AlvinPropose, AlvinAckPropose>(Pair(peer, message), "alvin/proposal")
    }
