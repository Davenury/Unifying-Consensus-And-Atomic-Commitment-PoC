...
import com.github.davenury.ucac.gpac.SinglePeersetSpec
import com.github.davenury.ucac.history.InitialHistoryEntry
import com.github.davenury.ucac.objectMapper
import com.github.davenury.ucac.utils.ApplicationComposeEnvironment
...
class SinglePeersetApiSpec {
    ...
    @Container
    private val environment = ApplicationComposeEnvironment(listOf(3))
    ...
    fun `sync api`(): Unit = runBlocking {
        ...
        val peer0Address =
            environment.getHost(1, 1) + ":" + environment.getMappedPort(1, 1)
